                  ...
                  {paginated.map(r => {
                    ...
                    return (
                      <li key={r.id} className={['rounded-xl px-4 py-3 flex items-start gap-3 group', isPast ? 'bg-white/[0.02] opacity-55' : 'bg-white/[0.03]'].join(' ')}>
                        ...
                        {!isPast && (
                          <div className="flex items-center gap-1.5 mt-2 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0">
                          <button
                            type="button"
                            onClick={() => setModal(r)}
        ...
        <div className="flex flex-col md:flex-row gap-4 items-start">
          ...
          <div className="flex-1 space-y-4 w-full">
            <section className="rounded-2xl bg-bg-card p-6">
              ...
              <div>
                <TimezonePicker value={timezone} onChangeAction={async (v) => {
                  setTimezone(v);
                  try {
