...
function Example({ name, shows, invoke, code }: ExampleProps) {
  return (
    <div>
      ...
      <CodeBlock title="discord" code={invoke} />
      <div className="mt-3">
...
export default function RuneExamplesPage() {
  ...
  return (
    ...
    >
      ...
      <GuideSection title="Rock, paper, scissors">
        <Example
      ...
      <GuideSection title="Password generator">
        <Example
          name="password: a random password"
      ...
      <GuideSection title="Word count">
        <Example
          name="wordcount: a frequency counter"
      ...
      <GuideSection title="Statistics embed">
        <Example
          name="stats: min, max, mean, median, mode"
      ...
      <GuideSection title="More to explore">
        <p>
          The same style powers plenty of other tags. A few ideas to build on:
        </p>
        <ProseTable
          headers={['tag', 'what it shows', 'invoke']}
          rows={[
            ['coin', 'choose, lower, and ||', 'f!tags coin heads'],
            ['reverse', 'join and the reverse builtin', 'f!tags reverse hello world'],
            ['countdown', 'a reverse for loop with i--', 'f!tags countdown 5'],
            ['palindrome', 'reverse and ==', 'f!tags palindrome racecar'],
            ['temp', 'num, round, and an if/elif/else chain', 'f!tags temp 100 c'],
            ['eightball', 'checking if an argument was given', 'f!tags eightball "will I win?"'],
            ['ship', 'a randomInt compatibility score', 'f!tags ship alice bob'],
            ['slot', 'random symbols with && and ||', 'f!tags slot'],
            ['dad', 'argument fallbacks', 'f!tags dad Bob'],
            ['uwu', 'a chain of replace calls', 'f!tags uwu hello there'],
            ['roman', 'walking value and letter tables', 'f!tags roman 1987'],
            ['collatz', 'while loops capped at 500 steps', 'f!tags collatz 27'],
            ['morse', 'dict lookups over split("")', 'f!tags morse sos'],
            ['rollstats', 'dict tallying with randomInt', 'f!tags rollstats 10'],
            ['regex', 'test, match, and regexReplace', 'f!tags regex'],
            ['primes', 'a sieve of Eratosthenes', 'f!tags primes 50'],
          ]}
        />
