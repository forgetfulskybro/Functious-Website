...
export const metadata: Metadata = {
  title: 'Rune Guide',
  description:
    'Rune is the sandboxed scripting language behind Fluxer tags. Learn the basics, write your first tag, and browse the full reference.',
};
  ...
  return (
    ...
    >
      ...
      <GuideSection title="Sandboxed by default">
        ...
        <p>
          When a tag fails, Fluxer replies with a short embed naming the category of the error
