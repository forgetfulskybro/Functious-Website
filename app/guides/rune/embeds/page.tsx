...
export const metadata: Metadata = {
  ...
  description:
    'Build rich Fluxer embeds in Rune with the embed() builder and chainable setters.',
};
...
export default function RuneEmbedsPage() {
  ...
  return (
    <GuidePage
      guide={RUNE_GUIDE}
      chapter={chapter}
      description="Build rich Fluxer embeds with the embed() builder and chainable setters."
    >
      ...
      <GuideSection title="Colors">
        ...
        <CodeBlock
          title="rune"
          code={'say(embed().color(0xFF0000))\nsay(embed().color("#FF0000"))\nsay(embed().color("red"))\nsay(embed().color("blurple"))'}
        />
      </GuideSection>
