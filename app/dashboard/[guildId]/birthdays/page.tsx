...
export default async function BirthdaysPage({ params }: Props) {
  ...
  return <BirthdaysClient user={session.user} guilds={dashboardGuilds} activeGuildId={guildId} userGuild={userGuild} initialData={emptyGuildData(guildId) as any} />;
}