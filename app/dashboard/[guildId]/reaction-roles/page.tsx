...
import ReactionRolesClient from './ReactionRolesClient';
...
export default async function RolesPage({ params }: Props) {
  ...
  return <ReactionRolesClient user={session.user} guilds={dashboardGuilds} activeGuildId={guildId} userGuild={userGuild} initialData={emptyGuildData(guildId) as any} />;
}
