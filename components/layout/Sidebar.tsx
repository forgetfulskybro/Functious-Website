...
const GUILD_NAV_LINKS: { label: string; href: string; icon: React.ReactNode }[] = [
  ...
  },
  {
    label: 'Audit Logs',
    href: 'audit-logs',
    icon: (<svg className="w-3.5 h-3.5 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"> <path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2" /> <rect x="9" y="3" width="6" height="4" rx="1" /> <line x1="8" y1="12" x2="16" y2="12" /> <line x1="8" y1="16" x2="14" y2="16" /> </svg>),
  },
  {
      ...
      <div className="px-5 py-4 border-b border-white/5">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <a href={"/status"} className={['text-xs mt-0.5', status?.online ? 'text-green-400' : 'text-white/35'].join(' ')}>
